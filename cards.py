...
# ==================   Cards Module ======================
"""
this contains all the basic classes needed for a card game
    ...
    def __str__(self):
        if self.cards:
            ...
            for card in self.cards:
                rep += str(card) + "\t" # every loop it adds the card to rep
        else:
            rep = "<Empty>"
        return rep
        ...
        for rounds in range(per_hand):
            for hand in hands:
                if self.cards:
                    ...
                    print("Can not continue to deal the deck is empty")
